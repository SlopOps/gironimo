...
ExecStartPost=/bin/bash -c 'for i in {1..300}; do curl -sf http://localhost:8000/health && exit 0; sleep 2; done; exit 1'
...
ExecStartPost=/bin/bash -c 'for i in {1..300}; do curl -sf http://localhost:8002/health && exit 0; sleep 2; done; exit 1'
